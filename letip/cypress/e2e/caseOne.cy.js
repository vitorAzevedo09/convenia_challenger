...
describe('App Case One EUR', () => {
  it('Should do correct calculations', () => {
    ...
    cy.get(".money__input").clear().type(73.23).trigger('change')
    cy.get('.slider__wrapper__input__range').eq(0).invoke('val', 13).trigger('change')
    cy.get('.slider__wrapper__input__range').eq(1).invoke('val', 10).trigger('change')
